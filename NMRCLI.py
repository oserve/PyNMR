#NMRCLI.py 08/2009 by Olivier Serve
...
class NMRCore(object):
	...
	def filterSetup(self, managerName, residuesList, dist_range, violationState, violCutoff, method):
		...
		return ConstraintFilter(self.ManagersList[managerName].pdb,resList,dist_range,violationState,float(violCutoff),method)
